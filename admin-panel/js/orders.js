    ...
    trTable = `
        <tr>
            ...
            <td>
                ...
                <a type="button" class="view" data-bs-toggle="modal" data-bs-target="#staticBackdrop" href="#staticBackdrop" title="" data-toggle="tooltip" data-original-title="View" onclick="createModal(${
                  order.id
                })">
                    <i class="material-icons"></i>
                </a>
